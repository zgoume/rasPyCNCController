...
class MainWindow(QStackedWidget):
    ...
    def _reconfigureJogWidget(self, pauseFlag):
        if pauseFlag:
            ...
            self.jogWidget.RunButton.setText( config_string_format( QApplication.translate("joyWidget", "Cancel (%BTN_OK+1%)", None, -1)) )
            self.jogWidget.LoadButton.originalText = self.jogWidget.LoadButton.text()
            self.jogWidget.LoadButton.setText(config_string_format( QApplication.translate("joyWidget", "Resume (%BTN_CANCEL+1%)", None, -1)))
    ...
    def exitRequest(self):
        ...
        question = QApplication.translate("cncController", "Do you really want to exit?", None, -1)
